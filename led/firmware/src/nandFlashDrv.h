...
//#define NAND_CE_PORT     PORT_CHANNEL_G
#define NAND_CE_PIN      PORTGbits.RG6
#define NAND_CE_PIN_LOW    (PLIB_PORTS_PinClear(PORTS_ID_0,PORT_CHANNEL_G, PORTS_BIT_POS_6))//PORTACLR = 0x0020
#define NAND_CE_PIN_HIGH   (PLIB_PORTS_PinSet(PORTS_ID_0,PORT_CHANNEL_G, PORTS_BIT_POS_6))//PORTASET = 0x0020
...
//#define NAND_WP_PORT     PORT_CHANNEL_C
